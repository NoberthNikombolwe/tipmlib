   ...
   <section id="Content_here">
        ...
        <div class="content_here">
            <div class="bookNO_back">
                ...
                <div class="bookimg">
                    <img src="https://us.sagepub.com/sites/default/files/upm-assets/styles/sage_thumbnail_width_150px/dotfeed/112074_book_item_112074.jpg" alt="">
            ...
            $sql = "SELECT * FROM books WHERE B_ID='709.9-710.2'";
