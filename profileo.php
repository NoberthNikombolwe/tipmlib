                            ...
                            foreach ($run as $data) {
                                ...
                                <form action="" method="get">
                                    <h4>Details</h4><br>
                                                    ...
                                                    <input type="text" name="Firstname" id="" value="<?=$data['Firstname'];?>"> <br><br>
                    
                                                    <label for="Middlename">Middlename</label><br><br>
                                                    <input type="text" name="Middlename" id="" value="<?=$data['Middlename'];?>"> <br><br>
                    
                                                    <label for="Lastname">Lastname</label><br><br>
                                                    <input type="text" name="Lastname" id="" value="<?=$data['Lastname'];?>"> <br><br>
                    
                                                    <label for="RegistrationNo">RegistrationNo</label><br><br>
                                                    <input type="text" name="RegistrationNumber" id="" value="<?=$data['RegistrationNumber'];?>" disabled> <br><br>
                                                
                                            </div>
                                            <div class="details_2">
                                                <br><br>
                                                <label for="Phone number">Phone number</label><br><br>
                                                <input type="text" name="PhoneNumber" id="" value="<?=$data['PhoneNumber'];?>"> <br><br>
                                                ...
                                                <input type="date" name="DateofBirth" id=""  max="2020-01-01" value="<?=$data['DateofBirth'];?>"> <br><br>
